...
namespace CourseManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260829070221_EnrollementTable_EnrolledByEmail")]
    partial class EnrollementTable_EnrolledByEmail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CourseManagement.Domain.Entities.Class", b =>
                {
                    ...
                    b.ToTable("Classes", "course.managment", t =>
                        {
                            t.HasCheckConstraint("Check_Classes_Name_Alphanumeric", "\"Name\" ~ '^[a-zA-Z0-9]+$'");
                        });
                });
            ...
            modelBuilder.Entity("CourseManagement.Domain.Entities.Course", b =>
                {
                    ...
                    b.ToTable("Courses", "course.managment", t =>
                        {
                            t.HasCheckConstraint("Check_Courses_Name_Alphanumeric", "\"Name\" ~ '^[a-zA-Z0-9]+$'");
                        });
                });
            ...
            modelBuilder.Entity("CourseManagement.Domain.Entities.Enrollment", b =>
                {
                    ...
                    b.Property<string>("EnrolledByEmail")
                        .IsRequired()
                        .HasColumnType("text");
